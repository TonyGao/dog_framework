$(document).ready(function () {
  $("body").on("click", "label.ef-checkbox", function (event) {
    ...
    if (notChecked) {
      ...
      $(this).find(".ef-checkbox-target").prop("checked", true);
      $(this).find(".ef-checkbox-target").val('1').trigger("change");
    } else {
      ...
      $(this).find(".ef-checkbox-target").prop("checked", false);
      $(this).find(".ef-checkbox-target").val('0').trigger("change");
    }
