$(document).ready(function () {
  $("body").on("click", "label.ef-checkbox", function (event) {
    ...
    if (notChecked) {
      ...
      $(this).find(".ef-checkbox-target").attr("checked", true);
      $(this).find(".ef-checkbox-target").attr("value", '1').trigger("change");
    } else {
      ...
      $(this).find(".ef-checkbox-target").attr("checked", false);
      $(this).find(".ef-checkbox-target").attr("value", '0').trigger("change");
    }
